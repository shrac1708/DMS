          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-6">
                  ...
                  <textarea id="w3review" placeholder="Enter Text" name="w3review" rows="10" cols="70"></textarea>
                                <br>
                                
                          </div>
                      <div class="panel-footer">
                            <div class="btn-signup">
                             <center><button type="submit" name="submit" class="btn " data-toggle="tooltip"  title="Adds new Notice">Add</button>
